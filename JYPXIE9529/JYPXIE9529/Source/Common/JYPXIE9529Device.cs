...
namespace JYPXIE9529
{
    ...
    /// 定义DSA专用的函数等
    /// </summary>
    internal class JYPXIE9529Device
    {
        #region --------------只读字段---------------

        private readonly ushort cardType = JYPXIE9529Import.PXI_9529;//DAQxxxImport.xxxx;
        /// <summary>
        ...
        /// </summary>
        private static List<JYPXIE9529Device> _listThisInst = null;
        ...
        #region ---------------AO相关字段---------------
        private readonly uint _AODBFBlockSize = 512;
        /// <summary>
        /// AO double buffer 缓冲区的块大小
        /// </summary>
        public uint AODBFBlockSize
        {
            get
            {
                return _AODBFBlockSize;
            }
        }

        private readonly uint _AONDBFBlockSize = 256;
        /// <summary>
        /// AO none double buffer 缓冲区的块大小
        /// </summary>
        public uint AONDBFBlockSize
        {
            get
            {
                return _AONDBFBlockSize;
            }
        }

        private bool _aoReserved;
        /// <summary>
        /// AO是否占用的标志
        /// </summary>
        public bool AOReserved
        {
            get
            {
                return _aoReserved;
        ...
        ///// DI端口及其线是否被占用
        ///// </summary>
        //public bool[] DILineReserved = new bool[] { false, false, false, false, false, false, false, false };        

        ///// <summary>
        ///// DO端口及其线是否被占用
        ///// </summary>
        //public bool[] DOLineReserved = new bool[] { false, false, false, false };\

        /// <summary>
        /// DI端口及其线是否被占用
        /// </summary>
        public bool[] DIOPortReserved = new bool[] { false, false, false };
        #region --------------------CIO字段---------------------------
        /// <summary>
        /// 定时器占用情况，
        /// </summary>
        public bool[] CIOReserved = new bool[] { false, false };
        ...
        /// <returns></returns>
        public static JYPXIE9529Device GetInstance(ushort cardNum)
        {
            if(_listThisInst == null || !_listThisInst.Exists(t=>t._cardnumber == cardNum))
            {
                JYPXIE9529Device inst = null;
                try
                {
                    inst = new JYPXIE9529Device(cardNum);
                }
                catch(Exception ex)
                {
                ...
                {
                    _listThisInst = new List<JYPXIE9529Device>();
                }
        ...
        /// 构造函数
        /// </summary>
        private JYPXIE9529Device(ushort cardNum)
        {
            _cardnumber = cardNum;
            _cardID = -1;
        ...
        private bool Initiate()
        {
            ...
            //在驱动中注册板卡
            cid = JYPXIE9529Import.DSA_Register_Card(cardType, _cardnumber);
        ...
        private int Release()
        {
            ...
            err = JYPXIE9529Import.DSA_Release_Card((ushort)_cardID);
