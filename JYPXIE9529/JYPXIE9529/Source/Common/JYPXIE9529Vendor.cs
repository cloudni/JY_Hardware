...
namespace JYPXIE9529
{
    ...
    internal class JYPXIE9529Import
    {
        ...
        public const ushort PXI9527_AIO_1to1 = 2;
        public const ushort PXI9527_AIO_2to1 = 3;
        ...
        //Timebase Constants
        //Timebase Source
        public const ushort P9527_Internal = 0x00;
        public const ushort P9527_PXI10M = 0x01;
        ...
        public const ushort P9529_AI_Coupling_AC = 0x10;
        public const ushort P9529_AI_EnableIEPE = 0x20;
        ...
        [DllImport("DSA-Dask.dll")]
        public static extern short DSA_AI_ContVScale(ushort CardNumber, ushort adRange, uint[] readingArray, double[] voltageArray, int count);
        [DllImport("DSA-Dask.dll")]
